...
const WelcomeApp: React.FC<WelcomeAppProps> = ({ 
  ...
  const headerImageUrl = typeof chrome !== 'undefined' && chrome.runtime?.getURL 
    ? chrome.runtime.getURL('assets/media/ai_inspector_app_top.png')
    : 'assets/media/ai_inspector_app_top.png';
  ...
  const handleImportOfficialResults = async () => {
    ...
    try {
      ...
      if (typeof chrome !== 'undefined' && chrome.runtime?.getURL) {
        ...
        resultsUrl = chrome.runtime.getURL('assets/files/results.zip');
            ...
            <div className="mb-3 flex justify-center">
              <img 
                src={typeof chrome !== 'undefined' && chrome.runtime?.getURL 
                  ? chrome.runtime.getURL('assets/media/gyrogovernance_stamp.png')
                  : 'assets/media/gyrogovernance_stamp.png'
                }
                alt="GyroGovernance" 
