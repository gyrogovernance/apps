    ...
    <div className={`${className}`}>
      <div className="relative">
        <details className="group" open={defaultOpen}>
          <summary className="cursor-pointer flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 rounded transition-colors list-none pr-12 [&::-webkit-details-marker]:hidden [&::marker]:hidden">
        ...
        <button
          onClick={handleCopy}
          className="absolute top-3 right-3 px-2 py-1 text-xs bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 rounded transition-colors shrink-0"
